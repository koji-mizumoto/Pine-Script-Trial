...
株、通貨(FX)を買いまたは売りで銘柄の取引（ポジション）を始めること  
FXの取引で使われることが多い  
短期売買で使われる

### イグジット／エグジット (Exit)

株、通貨(FX)を買いまたは売りで銘柄の取引（ポジション）を終了すること  
ベンチャービジネスや企業再生においてファンドや創業者が株式を売却し、**利益を得る行為**を指す。  
または、ベンチャーキャピタル等の投資ファンドによる投資回収を指す言葉としても用いられる。  
投資を回収する、利益確定、**損切**とも。  
短期売買で使われる

- ロングでエントリー -> ショートでイグジット　（銘柄が下がったところで売り）
- ショートでエントリー -> ロングでイグジット　（銘柄が上がったところで売り）
...
ダイバージェンスは、テクニカル指標の値が逆行する現象

### ヒドゥンダイバージェンス

ダイバージェンスの一種。価格は下降（安値更新）だが、テクニカル指標は上昇している
...
強いて挙げるなら、テンプレートを開いた後にパラメータの設定で色を変更することくらい。

### ボラティリティ

テクニカル指標、トレンド分析  
ボラティリティは、価格変動の大きさを示す指標  
